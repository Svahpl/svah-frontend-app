          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <div className="flex items-center flex-wrap">
                ...
                <a href="https://www.instagram.com/svah.2021?utm_source=qr&igsh=MTZrbGswaXE4dXhqeA%3D%3D" className="text-primary-700 hover:text-primary-900 transition-colors" target="_blank" rel="noopener noreferrer">
                  svah.2021
                </a>
                <span className="text-neutral-500 mx-2">|</span>
                <a href="https://www.instagram.com/svah_nurseries?utm_source=qr&igsh=N2Jpb3JwdmJmdmpk" className="text-primary-700 hover:text-primary-900 transition-colors" target="_blank" rel="noopener noreferrer">
                  svah_nurseries
                </a>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center">
                ...
                <a href="https://www.youtube.com/@svah-2021" className="text-primary-700 hover:text-primary-900 transition-colors" target="_blank" rel="noopener noreferrer">
                  @svah-2021
                </a>
              </div>
            </div>
