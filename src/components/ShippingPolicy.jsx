    ...
    <div className="py-16 bg-neutral-50">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl font-heading font-bold text-primary-800 mb-8 text-center">Shipping Policy</h1>

          <div className="bg-white rounded-lg shadow-md p-6 md:p-8 space-y-8">
            <section>
              <div className="flex items-center mb-4">
                <Globe className="text-primary-600 w-6 h-6 mr-3" />
                <h2 className="text-xl font-heading font-semibold text-primary-800">Shipping Coverage</h2>
              </div>
              <p className="text-neutral-700 leading-relaxed mb-4">
                We ship our products worldwide, partnering with reliable courier services to ensure safe delivery. All shipments are tracked and insured for your peace of mind.
              </p>
            </section>
            ...
            <section>
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-xl font-heading font-semibold text-primary-800">Processing Time</h2>
              </div>
            ...
            <section>
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-xl font-heading font-semibold text-primary-800">Delivery Timeframes</h2>
              </div>
              <ul className="list-disc list-inside text-neutral-700 space-y-2">
            ...
            <section>
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-xl font-heading font-semibold text-primary-800">Packaging</h2>
              </div>
              <p className="text-neutral-700 leading-relaxed mb-4">
            ...
            <section>
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-xl font-heading font-semibold text-primary-800">Returns & Refunds</h2>
              </div>
              <p className="text-neutral-700 leading-relaxed">
                Please refer to our Returns Policy for detailed information about our return and refund process. We strive to ensure customer satisfaction with every order.
              </p>
            </section>
          </div>
        </div>
