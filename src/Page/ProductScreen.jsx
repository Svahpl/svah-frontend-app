    ...
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-gray-900">
        ...
        <div className="md:hidden">
          {/* Header */}
          <div className="bg-white dark:bg-gray-900 px-4 py-4 flex items-center justify-between border-b border-gray-200">
            <ChevronLeft
              onClick={goBack}
              size={16}
            ...
            <div className="w-6 dark:bg-gray-900" />
          </div>
          ...
          <div className="px-8 py-12 relative">
            <button
              ...
              className="absolute top-4 right-4 p-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full hover:bg-white dark:hover:bg-gray-700 transition z-20"
            >
              <Heart
                className={`w-5 h-5 ${
                  isLiked
            ...
            <button
              onClick={prevImage}
              className="absolute left-2 top-1/2 -translate-y-1/2 p-2 bg-white/80 dark:bg-gray-800/80 rounded-full hover:bg-white dark:hover:bg-gray-700 transition z-20"
            >
              <ChevronLeft className="w-5 h-5 text-gray-700 dark:text-gray-300" />
            </button>
            <button
              onClick={nextImage}
              className="absolute right-2 top-1/2 -translate-y-1/2 p-2 bg-white/80 dark:bg-gray-800/80 rounded-full hover:bg-white dark:hover:bg-gray-700 transition z-20"
            >
                ...
                {product.images.map((img, i) => (
                  <div key={i} className="w-full flex-shrink-0">
                    <img
                      src={img}
                      alt={`${product.title} ${i}`}
                      className="w-full h-64 object-contain drop-shadow-lg dark:drop-shadow-2xl"
                    />
                  </div>
                ))}
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {product.keyIngredients.map((ingredient, index) => (
                    <span
                      key={index}
                      className="px-3 py-1 bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-300 text-xs rounded-full font-medium"
                    >
                      {ingredient}
                    </span>
                  ))}
                ...
                {weights.map((w) => (
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-full text-xs font-medium transition ${
                      selectedWeight === w
                        ? "bg-green-950 dark:bg-green-800 text-white shadow scale-105"
            ...
            <div className="space-y-3">
              {product.quantity <= 0 ? (
                <>
                  <button
                    onClick={() => addToCart()}
                    className="w-full bg-green-800 dark:bg-green-700 text-white font-semibold py-3 px-4 rounded-lg flex items-center justify-center space-x-2 transition shadow hover:shadow-lg transform hover:scale-105 dark:hover:bg-green-600"
                  >
              ...
              {product.quantity <= 0 ? (
                <>
                  <button
                    ...
                    className="w-full bg-gray-900 dark:bg-gray-700 hover:bg-gray-800 dark:hover:bg-gray-600 text-white font-semibold py-3 px-4 rounded-full transition shadow hover:shadow-lg transform hover:scale-105"
                  >
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <textarea
                      ...
                      className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-green-800 dark:focus:ring-green-400 focus:border-green-800 dark:focus:border-green-400 outline-none resize-none placeholder-gray-500 dark:placeholder-gray-400"
                      rows={3}
                    />
                ...
                <div className="space-y-6">
                  {comments?.length > 0 ? (
                    ...
                    <div className="text-center py-8">
                      <MessageSquare className="w-10 h-10 mx-auto text-gray-400 dark:text-gray-500" />
        ...
        <div className="hidden md:block max-w-7xl mx-auto px-6 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-3xl p-12 relative overflow-hidden dark:bg-gray-800">
                <button
                  onClick={() => addToWishlist()}
                  className="absolute top-6 right-6 p-3 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-full hover:bg-white dark:hover:bg-gray-800 transition shadow-lg hover:shadow-xl transform hover:scale-110 z-20"
                >
                  <Heart
                    className={`w-6 h-6 ${
                      isLiked
                ...
                <button
                  onClick={prevImage}
                  className="absolute left-6 top-1/2 -translate-y-1/2 p-3 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-full hover:bg-white dark:hover:bg-gray-800 transition shadow-lg z-20"
                >
                  <ChevronLeft className="w-6 h-6 text-gray-700 dark:text-gray-300" />
                </button>
                <button
                  onClick={nextImage}
                  className="absolute right-6 top-1/2 -translate-y-1/2 p-3 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-full hover:bg-white dark:hover:bg-gray-800 transition shadow-lg z-20"
                >
                  ...
                  {product.images.map((_, i) => (
                    <button
                      ...
                      className={`w-3 h-3 rounded-full ${
                        i === currentImageIndex
                          ? "bg-green-950 dark:bg-green-700"
                          : "bg-gray-300 dark:bg-gray-600 hover:bg-gray-400 dark:hover:bg-gray-500"
                      }`}
                    />
                  ))}
