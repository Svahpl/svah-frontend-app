...
const PrivacyPolicy = () => {
  return (
    <div className="bg-[#fdfcf9] text-[#2c2c2c] min-h-screen px-4 py-12 sm:px-8 lg:px-32">
      <div className="max-w-5xl mx-auto bg-white shadow-2xl rounded-2xl p-8 sm:p-12 border border-green-100">
         <Header />
